...
if ($_SERVER['REQUEST_METHOD'] != 'POST') {
    echo "<h1 style='text-align: center; font-size: 36px;'>Add a Student into the VCU Student Database</h1>";
    echo "<form method='post' action='AddStudentPage.php'>";
    echo "<table style='border: solid 1px black;'>";
    echo "<tbody>";
    echo "<tr><td>V-Number <span style='color: red;'>*</span> </td><td><input name='V_number' type='text' size='25'></td></tr>";
